...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Edit Content - <?php echo  $_SERVER[ "HTTP_HOST" ]; ?></title>		<link rel="stylesheet" type="text/css" href="css/admin-style.css">
	...
	<body>
		<div id="wrapper">
			<h1 class="icon-edit heading">Edit Content</h1>
